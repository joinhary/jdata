...
class NhanVienController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($roles != 'admin') {
            ...
            $nhanvien->where('nhanvien.nv_vanphong', '=', $role);
        } else {
            $tong = NhanVienModel::join('users', 'users.id', '=', 'nv_id')
                ->join('chinhanh', 'cn_id', '=', 'nv_vanphong')
                ->join('role_users', 'user_id', '=', 'nv_id')
        ...
        return view('admin.nhanvien.index', compact('nhanvien', 'count', 'tong', 'search', 'roles','vanphong'));
    }

    public function create(Request $request)
    {
        $chinhanh = $this->listChinhanh($request)->pluck('cn_ten', 'cn_id');
        $chucvu = $this->listRoles()->pluck('name', 'id');
