...
class  HeadingSuuTraSheet12A implements FromView, WithTitle,WithEvents
{
    private $data;
    ...
    {
        return view('admin.report.export12a',[
            'data' => $this->data
        ]);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $maxrow = $event->getSheet()->getDelegate()->getHighestRow() -5;
                $cellRange = "A1:K" . $lrow;
