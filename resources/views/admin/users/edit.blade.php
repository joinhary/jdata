                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                {!! \App\Helpers\Form::model($user, ['url' => URL::to('admin/users/'. $user->id.''), 'method' => 'put', 'class' => 'form-horizontal','id'=>'commentForm', 'enctype'=>'multipart/form-data','files'=> true]) !!}
                                    {{ csrf_field() }}
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab3" disabled="disabled">
                                                ...
                                                <div class="form-group required {{ $errors->first('country', 'has-error') }}">
                                                    ...
                                                    <div class="col-sm-10">
                                                        {!! \App\Helpers\Form::select('country', $countries,old('country',$user->country),array('class' => 'country_field form-control')) !!}
