    ...
    <section class="content">
        <div class="row">
            <div class="panel-heading col">
               <div  class="col-sm-6">
                   <h4 class="panel-title">Lịch sử giao dịch  <b>{{$ten}}</b></h4>
                    ...
                    <table id="noi-bo-table" class="table-bordered  ">
                        ...
                        @foreach($data as $val)
                                    <tr>
                                        ...
                                        <td style="font-size: 13px">{{ $val->ngayky }}</td>
                                        <td style="font-size: 13px">{{ $val->so_cc }}</td>
                                        <td class="p-4"
                                            style="font-size: 13px;text-align: center;">@if(strlen($val->vb_nhan) > 150)
                                                {{substr($val->ten_hd, 0, 150)}}
                                                    ...
                                                    <div class="modal-dialog modal-sm"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p style="text-align: center;font-size: 13px;text-align: justify;color: black">
                                                                    {!!$val->ten_hd !!}
                                            ...
                                            @else
                                                <a href="{{route('xemNoiDungV2',$val->id)}}" target='_blank'>  {{$val->vb_nhan}}</a>
                                            @endif</td>
                                        <td style="font-size: 13px">{{ $val->first_name }}</td>
                                        <td style="font-size: 13px">{{ $val->nvnv_id }}</td>

                                        <td style="font-size: 13px">{{ $val->cn_ten }}</td>
