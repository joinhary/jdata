            ...
            <div class="portlet box">
                ...
                <div class="panel panel-primary" id="hidepanel6">
                    ...
                    <div class="panel-body">
                        <form action="{{route('updateLyLich',['id'=>$lylich->id])}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                                ...
                                <div class="col-md-10 p-0">
                                    <label class="radio-inline">
                                        &nbsp;<input type="radio" name="tinhtrang" class="custom-radio" value="1"
                                                     required {{ $lylich->tinhtrang == 1?'checked':'' }}>&nbsp;Ngăn
                                        chặn</label>
                                    <label class="radio-inline">
                                        <input type="radio" name="tinhtrang" class="custom-radio"
                                               value="2" {{ $lylich->tinhtrang == 2?'checked':'' }}>&nbsp;Giải
                                        chấp</label>
                                    <label class="radio-inline">
                                        <input type="radio" name="tinhtrang" class="custom-radio"
                                               value="3" {{ $lylich->tinhtrang == 3?'checked':'' }}>&nbsp;Giải
                                        tỏa</label>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-md-10 p-0">
                                    <input type="text" class="form-control" id="sohoso" name="sohoso"
                                           placeholder="Số HS/CV"  maxlength="20" value="{{ $lylich->sohoso }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-md-10 p-0">
                                    <input type="date" class="form-control" id="ngayky" name="ngayky"
                                           placeholder="Ngày ký" required value="{{ $lylich->ngayky }}" disabled>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="form-group col-md-12 p-0">
                                <div class="col-md-8 p-0">
                                    ...
                                    <textarea class="form-control" name="mota"  rows="5"
                                              style="resize: vertical">{{ $lylich->mota }}</textarea>
                                </div>
                                <div class="col-md-4 p-0 pl-1">
                                    <label for="lylich_hinhanh" class="label-line"><b>Hình ảnh:</b></label>
                                    <div class="col-12 border-custom p-1 pt-1 text-center">
                                        <div class="row mb-half text-left">
                                            <span class="text-warning"><i class="fa fa-exclamation-triangle"></i> Chỉ chọn lại ảnh khi thật sự cần cập nhật!</span>
                                            <input id="lylich_hinhanh" name="lylich_hinhanh[]" type="file" accept="image/*" class="form-control" multiple onchange="loadImg(this)">
                                        </div>
                                        <div class="row text-center row-image" id="images">
                                            @if($images)
                                                @foreach($images as $img)
                                                    <div class="col-md-3 mb-2" id="">
                                                        <a href="{{url('images/lylich').'/'.$img}}" data-fancybox="images"   >
                                                            <img src="{{url('images/lylich').'/'.$img}}" width="50" height="50">
                                                        </a>
                                                    </div>
                                                @endforeach
                                            @endif
                                ...
                                <div class="row"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label>CCV:</label>
                                                {!! \App\Helpers\Form::select('ccv_id',$ccv,$lylich->ccv_id,['id' => 'ccv_id','class'=>'form-control select2 ','required']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                {!! \App\Helpers\Form::select('nhanviennv_id',$cv,$lylich->nhanviennv_id,['id' => 'nhanviennv_id','class'=>'form-control select2']) !!}
                            ...
                            <div class="form-group text-center">
                                <button type="submit" id="sub-lylich" onclick="block()"  class="btn btn-responsive btn-primary">Xác nhận</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        $('#sohoso').focusout(function () {
            ...
            $.ajax({
                ...
                type: 'GET',
                data: 'id=' + id + '&sohoso=' + $('#sohoso').val() + '&type=edit',
        ...
        $('#so_vaoso').focusout(function () {
            $.ajax({
                ...
                type: 'GET',
                data: 'so_vaoso=' + $('#so_vaoso').val() + '&type=edit',
                success: function (res) {
                    if (res.status === 'error') {
