           ...
           >
                    ...
                    @else
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-lg-8">
                                {!! \App\Helpers\Form::select('vb_kieuhd',$kieuhd,$data->loai,['id'=>'kieuhd','class'=>'form-control sel','required','style'=>'width: 100%']) !!}
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-lg-4 col-form-label nqkright">
                            ...
                            <div class="col-lg-8">
                                @if($role!="ke-toan")
                                    {!! \App\Helpers\Form::select('ten',$vanban,$data->van_ban_id,['id'=>'ten','class'=>'form-control sel','required']) !!}
                                @else
                                    {!! \App\Helpers\Form::select('ten',$vanban,$data->van_ban_id,['id'=>'ten','class'=>'form-control sel','disabled=disabled']) !!}
                                @endif
                            </div>
                        </div>
                    @endif
{{--                        {{ dd(intval($data->vanban)) }}--}}
					...
					<div class="form-group col-md-12" >
                        ...
                        <div class="col-lg-8">
                                ...
                                {!! \App\Helpers\Form::select('cv_id',$cv,$data->cv_id,['id'=>'cv_id','class'=>'form-control sel']) !!}
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-lg-4 col-form-label nqkright">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="so_hd" name="so_hd" class="form-control"
                                   placeholder="Nhập số hợp đồng ..." value="{{$data->so_hd}}"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            <input data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" type="date" id="ngay_cc" value="{{ $data->ngay_cc }}" name="ngay_cc"
                                   class="form-control" @if($role=="ke-toan") disabled @endif required>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="so_hd" value="{{$data->so_cc_cu}}" name="description" class="form-control"
					...
					<div class="form-group col-md-12" >
                        ...
                        <div class="col-lg-8">
                        {!! \App\Helpers\Form::select('bank',$bank,$data->bank_id,['id'=>'bank','class'=>'form-control sel ']) !!}
                    ...
                    @if($role <> "ke-toan")
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input value="{{$data->thu_lao}}" id="thulao" disabled class="form-control">
                                    <div class="input-group-prepend">
                                            <span class="input-group-text"
                                                  style="padding-bottom: 0px;padding-top: 0px;">vnđ</span>
                                    </div>
                        ...
                        <div class="form-group col-md-12">
                            <label class="col-lg-4 col-form-label nqkright">
                                <div class="col-lg-12">Thù Lao mới:</div>
                            </label>
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" value="{{old('thu_lao')}}" class="form-control"
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input value="{{$data->phi_cong_chung}}" id="phicongchung" disabled
                                           class="form-control">
                                    <div class="input-group-prepend">
                                            <span class="input-group-text"
                                                  style="padding-bottom: 0px;padding-top: 0px;">vnđ</span>
                        ...
                        <div class="form-group col-md-12">
                            <label class="col-lg-4 col-form-label nqkright">
                                <div class="col-lg-12">Phí công chứng mới:</div>
                            </label>
                            <div class="col-lg-8">
                                <div class="input-group">
...
@if(Sentinel::inRole('admin'))
						   <div class="form-group col-md-12">
                        <label class="col-lg-4 col-form-label nqkright">
                            <div class="col-lg-12">Số công văn giải toả:</div>
                        </label>
                        <div class="col-lg-8">
                            <input type="text" id="release_doc_number" name="release_doc_number" class="form-control" value="{{$data->release_doc_number}}"
                                   placeholder="Nhập số công văn giải toả...">
                        </div>
                    </div>
					<div class="form-group col-md-12">
                        <label class="col-lg-4 col-form-label nqkright">
                            <div class="col-lg-12">
                                Ngày giải toả: (<span class="text-danger qksao">*</span>)
                            </div>
                        </label>
                        <div class="col-lg-8">
                            <input type="date" id="release_doc_date" name="release_doc_date" value="{{$data->release_doc_date}}"
                                   class="form-control" >
                        </div>
                    </div>
					<div class="form-group col-md-12">
                        ...
                        <label class="col-lg-4 col-form-label nqkright">
                            <div class="col-lg-12">Tệp công văn giải toả:</div>
                        </label>
                        ...
                        <div class="col-lg-8">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div>
                            <span class=" btn-file">
                                <input id="release_file_name" name="release_file_name[]" type="file" accept="application/pdf"
                                       class="form-control" onchange="loadImgKH(this,'modal')" multiple/>
                            </span>
                            <small><i style="color:red">Lưu ý: dùng pdf để hình ảnh được rõ nét khi tải file lưu trữ </i></small>
                                </div>
                            </div>
                        </div>
                    </div>
