            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active show in" id="ds-f">
                    <div class="row" id="rwdss" style="">
                        <div class="col-md-8">
                            <form action="{{ route('indexSuutraNew') }}" method="get" id="formSreach">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <a href="{{route('indexSuutra')}}" class="btn btn-primary">
                                <i class="fa fa-eye"></i>
                                Giao diện cũ
                            </a>
                        </div>
                    ...
                    @if($count>0)
                        <div class="row scrollable-list-suutra" style="overflow-x: hidden;">
                            ...
                            @foreach($data as $val)
                                @php
                                    ...
                                    $duong_su_cut=mb_substr($val->duong_su, 0,240, 'UTF-8');
                                    ...
                                    if($val->property_info||$val->transaction_content){
                                        $texte=$val->property_info.PHP_EOL.$val->transaction_content;
                                        $texteFull="<b>Tài sản: </b>".$val->property_info.PHP_EOL."<b>Nội dung: </b>".$val->transaction_content;
                                    }else{
                                        $texte=$val->texte;
                                        $texteFull=$val->texte;
                                    }

									$officeCode=\App\Models\ChiNhanhModel::find(\App\Models\NhanVienModel::find(Sentinel::check()->id)->nv_vanphong)->code_cn;

									$isEditAvailable=Sentinel::check()->isTruongVP()&&$officeCode==$val->sync_code;
                                $isUpdate=\App\Models\SuuTraLogModel::where('uchi_id',$val->uchi_id)->count();
								@endphp
                                <div class="col-sm-12"
                                     style="background-color: #f0f0f0;border-radius: 12px;padding: 10px;border: 1px solid #827c7c;border-color: #c7c2c2;">
                                    <div class="col-sm-12">
                                        <a style="color:#1a0dab;margin: 0px;font-size: 12px;margin-bottom: 5px; "><b>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header qkmodel">
                                                                <h5 class="modal-title qkmodel">Thông tin chi tiết</h5>
                                                            </div>
                        ...
                        @elseif($val->ngan_chan == \App\Models\SuuTraModel::WARNING) qkxanh @else qktrang @endif">{!!$duong_su !!}</span>
                                        ...
                                        <div class="col-sm-6 p-33"
                                            ...
                                            @if(strlen($texte) > 240)
                                                {{mb_substr($texte, 0, 240, 'UTF-8')}}
                                                <div class="modal fade bd-example-modal-sm"
                                                     id="more-content-md2-{{$val->st_id}}"
                                                     tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
                                                     aria-hidden="false">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                        ...
                        @elseif($val->ngan_chan == \App\Models\SuuTraModel::WARNING) qkxanh @else qktrang @endif">{!!$texteFull!!}</span>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-7" style="padding-left: 0px; ">
                                            <p style="margin: 0px;font-size: 12px;margin-top: 5px;">
                                                Ngày nhập:
                                                ...
                                                | Số CC: <b>{{ $val->so_hd }}</b> <span id="{{$val->st_id}}"
                                        ...
                                        <div class="col-sm-5" style="padding-left: 0px;">
                                            <div class="col-sm-10">
                                                <p style="margin: 0px;font-size: 12px;margin-top: 5px;">
                                                    ...
                                                    @if($val->is_update == 1||$isUpdate>1)
                                                        | <span style="color: red;">Cập nhật lần cuối bởi:{{ $val->user_update }} <span><i
                                                                        class="fa fa-angle-right"
                                                                        aria-hidden="true"></i></span></span>
                                                        <a href="{{ route('suutralogIndex',['uchi_id'=>$val->uchi_id]) }}"
                                            ...
                                            <div class="col-sm-2 d-flex justify-content-around">
                                                ...
                                                @endif
                                                @if(Sentinel::inRole('admin')&&$val->ngan_chan==\App\Models\SuuTraModel::PREVENT)
                                                    <a href="{{ route('editSuutra',['id' => $val->st_id]) }}"
                                                       class="button button-circle button-mid button-primary">
                                                        <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-danger qkmodel">
                                                                            <h4 class="modal-title qkmodel">Danh sách
                                                                                tập tin
                                                                            </h4>
                                                                        </div>
                ...
                <div class="tab-pane fade in" id="prevent-f">
                    <div class="row" id="rwprevents" style="">
                        <div class="col-md-8">
                            <form action="{{ route('indexSuutraNew') }}" method="get" id="formSreachprevent">
                        ...
                        <div class="row scrollable-list-suutra" style="overflow-x: hidden;">
                            ...
                            @foreach($data as $val)
                                ...
                                <div class="col-sm-12"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-4  p-22"
                                             style="padding-left: 0px;padding-right: 20px;text-align: justify; @if($val->ngan_chan == \App\Models\SuuTraModel::PREVENT) color: red
                                             @elseif($val->ngan_chan == \App\Models\SuuTraModel::WARNING) color: #016639 @else @endif">
                                            @if(strlen($val->duong_su) > 240)
                                                {!!mb_substr("<b>(Bên liên quan):</b> ".$val->duong_su, 0,240, 'UTF-8')!!}
                                                <div class="modal fade bd-example-modal-sm"
                                                     id="more-content-md-pre-{{$val->st_id}}"
                                                     tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
                                                     aria-hidden="false">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                ...
                                                <span style="white-space: pre-line"
                                                      class="@if($val->ngan_chan == \App\Models\SuuTraModel::PREVENT) qkdo
                        @elseif($val->ngan_chan == \App\Models\SuuTraModel::WARNING) qkxanh @else qktrang @endif">{!!$val->duong_su !!}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            @else
                                                {!!"<b>(Bên liên quan):</b> ".$val->duong_su!!}
                                            @endif
                                        </div>
                                        <div class="col-sm-8 p-33"
                                             style="padding-left: 20px;padding-right: 0px;text-align: justify; @if($val->ngan_chan == \App\Models\SuuTraModel::PREVENT) color: red
                                             @elseif($val->ngan_chan == \App\Models\SuuTraModel::WARNING) color: #016639 @else @endif ">
                                            <span><b>(Nội dung giao dịch): </b></span>
                                            @if(strlen($val->texte) > 240)
                                                {{mb_substr($val->texte, 0, 240, 'UTF-8')}}
                                                <div class="modal fade bd-example-modal-sm"
                                                     id="more-content-md2-pre-{{$val->st_id}}"
                                                     tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
                                                     aria-hidden="false">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                             ...
                                             <span style="white-space: pre-line"
                                                   class="@if($val->ngan_chan == \App\Models\SuuTraModel::PREVENT) qkdo
                        @elseif($val->ngan_chan == \App\Models\SuuTraModel::WARNING) qkxanh @else qktrang @endif">{!!$val->texte !!}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <span id="three-dot-{{$val->st_id}}">...</span>
                                                <span id="{{$val->st_id}}" onclick="showinfo2pre('{{$val->st_id}}')">
                                        <i id="search-icon-{{$val->st_id}}" class="fa fa-lg fa-search text-primary"></i>
                                    </span>
                                            @else
                                                {{$val->texte}}
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-6" style="padding-left: 0px; ">
                                            <p style="margin: 0px;font-size: 12px;margin-top: 5px;">
                                                ...
                                                <b>{{ \Illuminate\Support\Carbon::parse($val->ngay_nhap)->format('d/m/Y') }}</b>
                                                | Ngày
                                                CV: {{ \Illuminate\Support\Carbon::parse($val->ngay_cc)->format('d/m/Y') }}
                                                | Số CV: <b>{{ $val->so_hd }}</b> <span id="{{$val->st_id}}"
                                                                                        style="padding-left:10px"
                                                                                        onclick="showinfopre('{{$val->st_id}}')">
                                        <i id="search-icon-{{$val->st_id}}" class="fa fa-lg fa-search text-primary"></i>
                                    </span>
                                            </p>
                                        </div>
                                            ...
                                            <div class="col-sm-2 d-flex justify-content-around">
                                                ...
                                                @if($val->real_name)
                                                    @if(is_array($imgs))
                                                        <div class="row">
                                                            <a data-toggle="modal"
                                                               data-target="#img-pre-{{$val->st_id}}"
                                                               class="button button-circle button-mid button-primary">
                                                                <i class="fa fa-image"></i>
                                                            </a>
                                                            <div class="modal fade bd-example-modal-sm"
                                                                 id="img-pre-{{$val->st_id}}" role="dialog"
                                                                 aria-labelledby="modalLabeldanger">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-danger qkmodel">
                ...
                <div class="tab-pane fade in" id="ts-f">
                    <div class="row" id="rwdts" style="">
                        <div class="col-md-8">
                            <form action="{{ route('indexSuutraNew') }}" method="get" id="formSreachOther">
                    ...
                    @if($count>0)
                        <div class="row scrollable-list-suutra" style="overflow-x: hidden;">
                            ...
                            @foreach($data as $val)
                                ...
                                $officeCode=\App\Models\ChiNhanhModel::find(\App\Models\NhanVienModel::find(Sentinel::check()->id)->nv_vanphong)->code_cn;
                                $isEditAvailable=Sentinel::check()->isTruongVP()&&$officeCode==$val->sync_code;
								$isUpdate=\App\SuuTraLogModel::where('uchi_id',$val->uchi_id)->count();
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        function submit() {
            ...
            $('#formSreachOther').attr('action', "{{ route('indexSuutraNewOther') }}");
        ...
        $('#btnprintOther').click(function () {
            ...
            $('#formSreachOther').attr('action', "{{ route('PrintSuuTraNew') }}");
            $("#formSreachOther").submit();
        });
...
//                                "accuracy": "complementary"
        ...
        function showinfopre(id) {
            $('#more-content-md-pre-' + id).modal();

        }

        function showinfo2pre(id) {
            $('#more-content-md2-pre-' + id).modal();
