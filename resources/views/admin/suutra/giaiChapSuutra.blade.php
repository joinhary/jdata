...
@section('content')
    <section class="content">
        ...
        @endphp
        <form action="{{ route('updateGiaiChap',['id'=>$data->st_id]) }}" method="post" enctype="multipart/form-data">
            @csrf
...
{{--                        {{ dd(intval($data->vanban)) }}--}}
					...
					<div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            <textarea type="text" id="undisputed_note" name="undisputed_note" class="form-control mt-3" rows="7"
                                      cols="50" >{!! $data->undisputed_note !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group col-md-12" hidden>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-lg-8">
                                ...
                                <button type="submit" class="btn btn-primary qkbtn" href="#">Lưu</button>
                                <a href="javascript:history.back()" type="cancel"
