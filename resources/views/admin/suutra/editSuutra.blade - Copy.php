           ...
           >
                    ...
                    @else
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-lg-8">
                                {!! \App\Helpers\Form::select('vb_kieuhd',$kieuhd,Request::input('vb_kieuhd'),['id'=>'kieuhd','class'=>'form-control sel','required','style'=>'width: 100%']) !!}
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-lg-4 col-form-label nqkright">
...
{{--                        {{ dd(intval($data->vanban)) }}--}}
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            ...
                            @else
                                {!! \App\Helpers\Form::select('id_ccv',$ccv,Request::input('id_ccv'),['id'=>'id_ccv','class'=>'form-control sel','required']) !!}
                            @endif
                        </div>
                    </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-lg-4 col-form-label nqkright">
                            <div class="col-lg-12">
                                Số hợp đồng: (<span class="text-danger qksao">*</span>)
                            </div>
                        </label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            <input data-date-format="dd-mm-yyyy" type="date" id="ngay_cc" value="" name="ngay_cc"
