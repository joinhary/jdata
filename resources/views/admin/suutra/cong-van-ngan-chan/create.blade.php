    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                ...
                <form id="create-form" action="{{ route('storeCongVanNganChan') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="card-body mx-3">
                        <div class="row mb-3">
                            <div class="md-form col-3">
                                ...
                                <select class="form-control select2" id="kieu_hop_dong" name="kieu_hop_dong_id" onchange="capNhatSoLuongBenDuongSu()">
                                    @foreach($nhomHopDong ?? [] as $nhom)
                                        <option value="{{ $nhom->id }}">{{ $nhom->kieu_hd }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="md-form col-12">
                                ...
                                <textarea type="text" id="duongsu" name="duongsu" class="form-control mt-3" rows="6" cols="50" required></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="md-form col-12">
                                ...
                                <textarea type="text" id="noidung" name="noidung" class="form-control mt-3" rows="6" cols="50" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="btn-group" id="filterDay">
                                    ...
                                    <label>
                                        <input type="radio" name="loai" value="1" checked>Ngăn chặn
                                    </label>
                                    <label>
                                        <input type="radio" name="loai" value="0"> Giải tỏa
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="form-group col-12">
                                ...
                                <input id="pic" name="pic[]" type="file" accept="image/*" class="form-control"
                                       onchange="loadImgKH(this,'modal')" multiple/>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="save-btn" class="btn btn-success">Xác nhận</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="modal-content" style="background-color: #ffffff !important;">
                    ...
                    <div class="modal-body">
                        <div class="btn-group d-flex btn-group-lg" role="group">
                            ...
                            <button id="btn-ben-C" type="button" class="btn btn-secondary" data-toggle="modal" data-target="#modal-duong-su">Bên C</button>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Đóng</button>
                        <button type="button" class="btn btn-primary" id="update-duong-su">Lưu thông tin</button>
                    </div>
                </div>
            </div>
        </div>
