                ...
                <div class="col-sm-12">
                    @if($role=='admin' || $role=='chuyen-vien-so' || $vp === "2190")
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-lg-8">
                                <input type="text" value="{{$data->ten_hd}}" id="ten" name="ten"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="so_hd" name="so_hd" class="form-control"
                                   placeholder="Nhập số hợp đồng ..." value="{{$data->so_hd}}" required>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-lg-4 col-form-label nqkright">
                        ...
                        <div class="col-lg-8">
                            <input data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" type="date" id="ngay_cc" name="ngay_cc" value="{{ $data->ngay_cc }}"
                                   class="form-control" required>
                        </div>
                    </div>
					<div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            <input data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" type="date" id="prevent_doc_receive_date" name="prevent_doc_receive_date" value="{{ $data->prevent_doc_receive_date }}"
                                   class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            <textarea type="text" id="duongsu" name="duongsu" class="form-control mt-3"
                                      rows="2" cols="50" required>{!! $data->duong_su !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <div class="col-lg-4 col-form-label">
  ...
  Add
                        ...
                        <div class="col-lg-8">
                            <textarea type="text" id="noidung" name="noidung" class="form-control mt-3"
                                      rows="7" cols="50">{!! $data->texte !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-lg-4 col-form-label nqkright">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="ccv_master" name="ccv_master" value="{{$data->ccv_master}}" class="form-control"
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-lg-4 col-form-label nqkright">
                            <div class="col-lg-12">Nhập số công chứng củ:</div>
                        </label>
                        <div class="col-lg-8">
					...
					<div class="form-group col-md-12">
                        ...
                        <div class="col-lg-8">
                            <input data-date-format="dd-mm-yyyy" type="date" id="release_doc_date" name="release_doc_date" value="{{$data->release_doc_date}}"
                                   class="form-control" >
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-lg-4 col-form-label nqkright">
                            <div class="col-lg-12">
                                Ngày nhận công văn giải toả: 
                            </div>
                        </label>
                        <div class="col-lg-8">
                            <input data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" type="date" id="release_doc_receive_date" name="release_doc_receive_date" value="{{ $data->release_doc_receive_date }}"
                                   class="form-control" >
                        </div>
                    </div>
					<div class="form-group col-md-12">
