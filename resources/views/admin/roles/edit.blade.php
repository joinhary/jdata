            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body border">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="slug" placeholder="user" required
                               value="{{ $role->slug }}">
                    </div>
                    <div class="form-group">
                            ...
                            @if(count($permission)>0)
                                @foreach($permission as $item)
                                    <label for="" style="margin: 0 15px">
                                        <input type="checkbox"
                                               {{(in_array($item->permissions,array_keys($role->permissions)))?"checked":"" }}
                                               class="checkbox-inline first" name="permissions[]"
