...
@section('content')
    <section class="content">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Chỉnh sửa template cho loại hợp đồng {{ $template->loai_hop_dong ? mb_strtoupper($template->loai_hop_dong->vb_nhan) : '' }}</h5>
                <div class="card-body mx-3">
                    <form class="form" method="POST" action="{{ route('admin.templates.loai-hop-dong.update', $template->id) }}">
                        {{ csrf_field() }}
                        <div class="col-12">
