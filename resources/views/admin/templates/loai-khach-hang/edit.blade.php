...
@section('content')
    <section class="content">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Chỉnh sửa template cho loại đương sự {{ $template->loai_khach_hang ? mb_strtoupper($template->loai_khach_hang->k_nhan) : '' }}</h5>
                <div class="card-body">
                    <div class="row mt-3">
                        ...
                        <div class="col-12 mt-2">
                            <form class="form" method="POST" action="{{ route('admin.templates.loai-khach-hang.update', $template->id) }}">
                                {{ csrf_field() }}
                                <div class="col-12">
