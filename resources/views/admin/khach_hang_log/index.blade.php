...
@section('content')
    <section class="content">
        <form action="{{route('indexKhachHangLog')}}">
            <div class="row">
                ...
                <div class="col-md-3" style="margin-top: 23px">
                    ...
                    <a class="btn btn-danger" href="{{ route('indexKhachHangLog')}}">
                ...
                @foreach($logs as $log)
                    <tr>
                        ...
                        <td class="column-align qktd">
                            <a title="Chi tiết nhân viên" href="{{route('listKhachHangLog',$log['kh_id'])}}"
