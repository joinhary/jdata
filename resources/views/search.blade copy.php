...
<script>
    window.searchSohd3 = {!! json_encode(request('so_hd3') ?? '') !!};
</script>
<script>
...
$(window).on('load', function () {
    ...
    let keywordRaw = window.searchDuongSu || '';
